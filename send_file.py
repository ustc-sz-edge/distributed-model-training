...
for index in node_index:
    host='192.168.1.'+str(index + 10)
    user_name='edge' + "{:0>2d}".format(index+10)
    passwd='edge' + "{:0>2d}".format(index+10)

    upload_img(host, user_name, passwd)
# python3 send_file.py --local_path '/data/jcliu/AAFL' --remote_path '/data/jcliu/FL/'
